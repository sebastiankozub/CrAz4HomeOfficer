...
namespace ScreenRecorederFramework.ProcessTools
{
    public class LowLevelKeyboardListener
    {
        ...
        //public  delegate IntPtr SetHookDelegate(LowLevelKeyboardProc proc);
        //private SetHookDelegate _setHookReference;
